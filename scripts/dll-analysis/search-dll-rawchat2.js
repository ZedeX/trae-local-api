...
const searchTerm = 'LLMRawChatRequest';
...
console.log('\n=== Searching for ChatCompletionContext ===');
const searchTerm2 = 'ChatCompletionContext';
...
console.log('\n=== Searching for LLMUtilsChatRequest ===');
const searchTerm3 = 'LLMUtilsChatRequest';
