const { getAuthInfo, getDeviceIds, getApiHost, buildStreamHeaders, detectEdition, refreshTokenIfNeeded, getDeviceInfo, getIdeVersion, getIdeVersionCode } = require('./src/auth');
...
async function test() {
  try {
    console.log('=== Trae API Full Request Test v9 ===');
    ...
    const userInput = 'Say hello in one word.';
