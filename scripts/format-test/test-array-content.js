...
async function test1_llm_utils_chat_array_content() {
  console.log('\n' + '='.repeat(60));
  console.log('Test 1: /api/agent/v3/llm_utils_chat - array content');
...
async function test2_llm_utils_chat_with_model() {
  console.log('\n' + '='.repeat(60));
  console.log('Test 2: /api/agent/v3/llm_utils_chat - with model config');
  console.log('='.repeat(60));
...
async function test3_llm_raw_chat_array_content() {
  console.log('\n' + '='.repeat(60));
  console.log('Test 3: /api/ide/v1/llm_raw_chat - array content');
  console.log('='.repeat(60));
...
async function test5_chat_v1_array_content() {
  console.log('\n' + '='.repeat(60));
  console.log('Test 5: /api/ide/v1/chat - array content');
  console.log('='.repeat(60));
...
async function main() {
  ...
  const r1 = await test1_llm_utils_chat_array_content();
  results.push({ test: 'llm_utils_chat_array', status: r1?.status, isSSE: r1?.isSSE });
  await sleep(3000);

  const r2 = await test2_llm_utils_chat_with_model();
  results.push({ test: 'llm_utils_chat_with_model', status: r2?.status, isSSE: r2?.isSSE });
  await sleep(3000);

  const r3 = await test3_llm_raw_chat_array_content();
  results.push({ test: 'llm_raw_chat_array', status: r3?.status, isSSE: r3?.isSSE });
  await sleep(3000);
  ...
  const r5 = await test5_chat_v1_array_content();
  results.push({ test: 'chat_v1_array', status: r5?.status, isSSE: r5?.isSSE });
