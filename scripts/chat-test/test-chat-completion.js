...
async function testChatCompletion() {
  console.log('\n' + '='.repeat(60));
  console.log('Test: /api/ide/v1/chat_completion - OpenAI format');
  ...
  try {
    const resp = await makeRequest('POST', '/api/ide/v1/chat_completion', body);
...
async function testChatCompletionWithConfig() {
  console.log('\n' + '='.repeat(60));
  console.log('Test: /api/ide/v1/chat_completion - with config');
  console.log('='.repeat(60));
...
async function testChatCompletionFull() {
  console.log('\n' + '='.repeat(60));
  console.log('Test: /api/ide/v1/chat_completion - full OpenAI format');
  console.log('='.repeat(60));
...
async function main() {
  ...
  await testChatCompletionWithConfig();
  console.log('\nWaiting 3 seconds...');
  await new Promise(r => setTimeout(r, 3000));
  
  await testChatCompletionFull();
}
